...
//Si accedo directamente a api.php, indico ayuda de la API
if(!isset($_GET['postid'])){
    //$postId=$_GET['postid'];
    //echo $postId;
    echo ("<p>Para usar correctamente la API tienes estas dos opciones:</p>");
    echo ("<p><strong>/api/noticias/X</strong> devuelve el post numero X</p>");
    echo ("<p><strong>/api/noticias/</strong> devuelve todos los post</p>");
    
}
//Si le paso un numero de post, lo muestro
elseif ($_GET['postid']!=''  ){
    $postId=$_GET['postid'];
